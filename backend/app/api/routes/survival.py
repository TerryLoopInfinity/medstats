"""POST /api/analyze/survival — Kaplan-Meier 生存分析"""
import logging
...
from app.stats import survival
...
async def analyze_survival(req: AnalysisRequest) -> AnalysisResult:
    try:
    ...
    try:
        result = survival.run(df, req.params)
