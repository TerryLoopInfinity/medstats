"""POST /api/analyze/correlation — 相关分析"""
import logging
...
from app.stats import correlation
...
async def analyze_correlation(req: AnalysisRequest) -> AnalysisResult:
    try:
    ...
    try:
        result = correlation.run(df, req.params)
